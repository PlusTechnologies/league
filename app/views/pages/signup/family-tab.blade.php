                ...
                <div class="tab-content">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                          ...
                          {{Form::text('lastname', '', array('id'=>'firstname','class'=>'form-control','placeholder'=>'Last Name','tabindex'=>'2')) }}
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-4 col-md-4">
                        <div class="form-group">
                  ...
                  <div class="tab-pane" id="tab2">
                    <p>Add your players Information 
                      <a href="#" class="pull-right btn btn-primary btn-xs" data-toggle="modal" data-target="#addplayer">
...
var cropperplayer = new Croppic('upimageplayer', cropperOptionsplayer);
</script>
@stop
